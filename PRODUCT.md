...
- **A real exploratory Qwen3-8B M5 Pro control exists.** The provenance-safe
  self-conversion/control workflow (`llmtracefx-m5-control`,
  `llmtracefx/optimizer/lab/qwen3_8b/`) converted the exact official
  Qwen3-8B pin once and completed the deterministic 2K, 8K, and 16K tiers.
  The sanitized bundle is committed under
  `examples/optimizer/qwen3-8b-m5-control/`. It is a different model/system
  identity from Qwen3.8-27B, is exploratory rather than clean-boot
  publication evidence, and does not prove why the 27B run OOMed.
